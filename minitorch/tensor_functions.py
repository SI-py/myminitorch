...
class Mul(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        ...
        return (grad_output.f.mul_zip(grad_output, b),
...
class Sigmoid(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        ...
        neg_sigm = sigmoid.f.neg_map(sigmoid)
        neg_sigm = sigmoid.f.add_zip(neg_sigm, sigmoid._ensure_tensor(1.0),)

        return sigmoid.f.mul_zip(sigmoid.f.mul_zip(sigmoid, neg_sigm), grad_output)
